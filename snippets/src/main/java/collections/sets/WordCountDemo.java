...
public class WordCountDemo {
    ...
    static Set parseTokens(String line) {
        ...
        // asList method acts as bridge between array-based and collection-based APIs,
        // in combination with Collection.toArray().
        // HashSet constructor takes a collection, and List is a kind of Collection, so it
