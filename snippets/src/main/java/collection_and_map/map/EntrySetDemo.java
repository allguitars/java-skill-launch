...
// Check the following link for other useful methods provided by Map
...
public class EntrySetDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Calling entrySet method on the collection_and_map.map");
        map.entrySet().forEach(entry -> {
            System.out.println("key: " + entry.getKey() + "; value: " + entry.getValue());
        });

        // You can also use the forEach method directly on the collection_and_map.map
        System.out.println("Calling forEach method directly on the collection_and_map.map:");
