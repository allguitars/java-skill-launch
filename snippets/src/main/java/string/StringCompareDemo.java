...
public class StringCompareDemo {
    ...
    public static void main(String[] args) {
        ...
        // 2. Do not compare string literal and new string object with == operator
        ...
        System.out.println("Java".equals(a));  // true, call equals() on string literal to avoid NullPointerException
        System.out.println(a.equals(b));       // false, a and b are both string literals but have different characters
        System.out.println(a.equals(c));       // true, a anc c are both string literals with the same characters

        System.out.println("a is a string literal, and d is a 'new' string. Both are 'Java':");
        ...
        System.out.println("e and f are 'new' string objects with different content:");
        System.out.println(e.equals(f));  // false

        // Second Summary:
        // 1. equals() can be used to compare string literal and new string
        // 2. equals() can be used to compare two string literals and two 'new' strings
        // 3. One should use equals() method to check if two String contains exactly
        //    the same characters in the same order.

        // Finally, why should we call equals on the string literal or known object?
        // When g is an unknown string object, or you are not sure if g is null
        String g = null;
