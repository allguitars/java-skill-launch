...
public class GetAllKeysValuesDemo {
    ...
    public static void main(String[] args) {
        ...
        // com.cddrm.javasnippets.collection_and_map.map.values().forEach(value -> System.out.println(value));
        // you can also use method reference instead of com.cddrm.javasnippets.lambda
        map.values().forEach(System.out::println);

        // Use enforced for loop
        System.out.println("Using enforced for loop:");
        myForEach(map.keySet());   // keySet method returns a set
        myForEach(map.values());   // values method returns a com.cddrm.javasnippets.collection_and_map.collection
    }
