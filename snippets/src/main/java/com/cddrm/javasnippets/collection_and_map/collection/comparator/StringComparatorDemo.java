package com.cddrm.javasnippets.collection_and_map.collection.comparator;
...
public class StringComparatorDemo {
    ...
    public static void main(String[] args) {
        ...
        // the compare() method, we can use com.cddrm.javasnippets.lambda expression to implement it on the go
