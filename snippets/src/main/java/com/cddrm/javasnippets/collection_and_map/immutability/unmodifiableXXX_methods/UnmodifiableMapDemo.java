package com.cddrm.javasnippets.collection_and_map.immutability.unmodifiableXXX_methods;
...
public class UnmodifiableMapDemo {
    ...
    public static void main(String[] args) {
        ...
        // Get an unmodifiable version of the com.cddrm.javasnippets.collection_and_map.map
        ...
        // But actually it is still referencing to the same com.cddrm.javasnippets.collection_and_map.map
        names.put(4, "Irene");
