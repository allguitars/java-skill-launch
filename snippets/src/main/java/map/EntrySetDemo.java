...
public class EntrySetDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Calling entrySet method on the map");
        map.entrySet().forEach(entry -> {
            System.out.println("key: " + entry.getKey() + "; value: " + entry.getValue());
        });

        // You can also use the forEach method directly on the map
        System.out.println("Calling forEach method directly on the map:");
