...
// In this example, we want to map the name string to a Person object.
public class ConstructorReferenceDemo {

    public static void main(String[] args) {
        List<String> names = List.of("Dave", "Stanley", "Ian");

        // ** Approach 1: the verbose way -- define a Function instance without lambda
        ...
        // It is smart enough to know it should pass the name string into apply() method,
