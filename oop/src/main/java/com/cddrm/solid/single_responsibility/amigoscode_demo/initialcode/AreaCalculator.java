...
public class AreaCalculator {
    ...
    // at some point, we want to add another method here to return the sum of area with JSON format
    // This breaks the single responsibility rule
    // This method is just for generating the JSON com.cddrm.javasnippets.string of the result, and it does not have
